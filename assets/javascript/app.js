...
// array to hold the data of questions, options and answers
var Trivia = [
    {
    ...
    {
        q: "What is the probabilty of getting a heart suit in a 52 deck of cards?",
        a: "1/4",
        answerChoices: ["1/2", "2/5", "1/13", "1/4"]
    }
]

// variable to hold the setinterval for the countdown of time
var InterValid;
...
//function to start the game when you click the start button
function start() {
    if (!clickStart) {
        display(count);
